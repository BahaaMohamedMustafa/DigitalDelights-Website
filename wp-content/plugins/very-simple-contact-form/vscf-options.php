...
function vscf_admin_init() {
	...
	add_settings_field( 'vscf-field-29', esc_attr__( 'Bad words', 'very-simple-contact-form' ), 'vscf_field_callback_29', 'vscf-general', 'vscf-general-section' );
	register_setting( 'vscf-general-options', 'vscf-setting-29', array('sanitize_callback' => 'sanitize_text_field') );

	add_settings_field( 'vscf-field-30', esc_attr__( 'Bad words', 'very-simple-contact-form' ), 'vscf_field_callback_30', 'vscf-general', 'vscf-general-section' );
	...
	add_settings_field( 'vscf-field-13', esc_attr__( 'Email', 'very-simple-contact-form' ).' - '.esc_attr__( 'Error', 'very-simple-contact-form' ), 'vscf_field_callback_13', 'vscf-label', 'vscf-label-section' );
	...
	add_settings_field( 'vscf-field-8', esc_attr__( 'Links', 'very-simple-contact-form' ).' - '.esc_attr__( 'Error', 'very-simple-contact-form' ), 'vscf_field_callback_8', 'vscf-label', 'vscf-label-section' );
	register_setting( 'vscf-label-options', 'vscf-setting-8', array('sanitize_callback' => 'sanitize_text_field') );

	add_settings_field( 'vscf-field-31', esc_attr__( 'Bad words', 'very-simple-contact-form' ).' - '.esc_attr__( 'Error', 'very-simple-contact-form' ), 'vscf_field_callback_31', 'vscf-label', 'vscf-label-section' );
...
function vscf_field_callback_28() {
	...
	<label><input type='checkbox' name='vscf-setting-28' <?php checked( esc_attr($value), 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Disable email to admin.', 'very-simple-contact-form' ); ?></label>
	<?php
}
...
function vscf_field_callback_35() {
	...
	<p><i><?php esc_attr_e( 'The subject for email to admin.', 'very-simple-contact-form' ); ?></i></p>
	<?php
}
...
function vscf_field_callback_15() {
	...
	<p><i><?php esc_attr_e( 'The subject for auto-reply email to sender.', 'very-simple-contact-form' ); ?></i></p>
	<?php
}
...
function vscf_field_callback_27() {
	...
	<p><i><?php esc_attr_e( 'Labels remain available for screen readers.', 'very-simple-contact-form' ); ?></i></p>
	<?php
}
...
function vscf_field_callback_29() {
	...
	<p><i><?php esc_attr_e( 'Disallow bad words in form submissions.', 'very-simple-contact-form' ); ?></i></p>
	<p><i><?php esc_attr_e( 'Use a comma to separate multiple words.', 'very-simple-contact-form' ); ?></i></p>
	<?php
}
...
function vscf_field_callback_30() {
	...
	<label><input type='checkbox' name='vscf-setting-30' <?php checked( esc_attr($value), 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Ignore form submissions with bad words.', 'very-simple-contact-form' ); ?></label>
	<p><i><?php esc_attr_e( 'Form submissions are not listed in dashboard and no email is send.', 'very-simple-contact-form' ); ?></i></p>
	<?php
}
...
function vscf_field_callback_32() {
	...
	<p><i><?php esc_attr_e( 'Limit input by using the maxlength attribute.', 'very-simple-contact-form' ); ?></i></p>
	<?php
}
...
function vscf_field_callback_34() {
	...
	<label><input type='checkbox' name='vscf-setting-34' <?php checked( esc_attr($value), 'yes' ); ?> value='yes'> <?php esc_attr_e( 'Display validation errors of hidden anti-spam features.', 'very-simple-contact-form' ); ?></label>
	<p><i><?php esc_attr_e( 'Errors are displayed underneath form after submit button is clicked.', 'very-simple-contact-form' ); ?></i></p>
	<?php
}
...
function vscf_field_callback_31() {
	$placeholder = __( 'Please remove bad words', 'very-simple-contact-form' );
...
function vscf_field_callback_16() {
	...
	<p><i><?php esc_attr_e( 'Displayed when sending succeeds.', 'very-simple-contact-form' ); ?></i></p>
	<?php
}
...
function vscf_field_callback_17() {
	...
	<p><i><?php esc_attr_e( 'Displayed in the auto-reply email to sender.', 'very-simple-contact-form' ); ?></i></p>
	<?php
}
